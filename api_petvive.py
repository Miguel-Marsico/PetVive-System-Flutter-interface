...
dao = AnimalDAOImplPostgresql('APIPETVIVE', 'postgres', '1920', 'localhost') #  Initializes the AnimalDAO implementation with connection details to the PostgreSQL database.
usuario_dao = UsuarioDAOImplPostgresql('APIPETVIVE', 'postgres', '1920', 'localhost') #  Initializes the UserDAO implementation with connection details to the PostgreSQL database.
